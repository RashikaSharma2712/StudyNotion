    ...
    <>
      <form onSubmit={handleSubmit(submitProfileForm)}>
        ...
        <div className="flex justify-end gap-2">
          ...
          <button
            type="submit"
            className="cursor-pointer rounded-lg bg-yellow-50 py-2.5 px-7 text-sm font-medium text-richblack-900 transition-all duration-200 hover:bg-yellow-25 hover:scale-105"
          >
            Save
          </button>
        </div>
